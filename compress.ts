...
// 압축 함수
async function compressText(originalText:string) {
    try {
        ...
        console.error('Error in compressText:', error);
        throw error;
    }
}

// 디코드 함수
async function decompressText(compressedText:string,method:number) {
    try {
        ...
        console.error('Error in decompressText:', error);
        throw error;
    }
}
